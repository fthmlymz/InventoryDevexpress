...
namespace InventoryManagement.Frontend.Pages.Product
{
    public partial class GetByIdProductAndDetails : ComponentBase
    {
        ...
        //#region Report DevExpress.Blazor.Reporting.Viewer ve DevExpress.Drawing.Skia
        //HarfBuzzSharp.NativeAssets.WebAssembly, SkiaSharp.HarfBuzz, SkiaSharp.NativeAssets.WebAssembly,
        //SkiaSharp.Views.Blazor, 
        //private DevExpress.XtraReports.UI.XtraReport _report = new Reports.EmbezzlementForm();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            Console.WriteLine(JsonSerializer.Serialize(_productDetailModelDto?.data));
        }
